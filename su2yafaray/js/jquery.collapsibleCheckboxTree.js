...
(function($) {
	...
	$.fn.collapsibleCheckboxTree = function(options) {
		...
		this.each(function() {
			...
			$("li:has(> ul:not(.hide)) > span", $(this)).addClass('expanded').html('<img src="img/open.png">');
			$("li:has(> ul.hide) > span", $(this)).addClass('collapsed').html('<img src="img/close.png">');
			...
			$("input[type='checkbox']", $(this)).click(function(){
				...
				if ($(this).is(":checked")) {
					...
					// Update the tree
					$("> span.collapsed", $(this).parent("li")).removeClass("collapsed").addClass("expanded").html('<img src="img/open.png">');
				...
				// If unchecking...
					...
					if (defaults.uncheckChildren) {
						...
						// Update the tree
						$("span.expanded", $(this).parent("li")).removeClass("expanded").addClass("collapsed").html('<img src="img/close.png">');
					}
				}
			...
			$("li:has(> ul) span", $(this)).click(function(){
				...
				if ($(this).is(".collapsed")) {
					...
					$("> ul", $(this).parent("li")).removeClass('hide');
					// ... and update the html
					$(this).removeClass("collapsed").addClass("expanded").html('<img src="img/open.png">');
				...
				// If was previously expanded...
					...
					$("> ul", $(this).parent("li")).addClass('hide');
					// and update the html
					$(this).removeClass("expanded").addClass("collapsed").html('<img src="img/close.png">');
				}
			...
			$("#expand").click(function () {
				...
				// and update the html
				$("li:has(> ul) > span", $root).removeClass("collapsed").addClass("expanded").html('<img src="img/open.png">');
				return false;
			});
			// Collapse all
			$("#collapse").click(function () {
				...
				// and update the html
				$("li:has(> ul) > span", $root).removeClass("expanded").addClass("collapsed").html('<img src="img/close.png">');
				return false;
			});
			...
			$("#default").click(function () {
				...
				// and update the html
				$("li:has(> ul:not(.hide)) > span", $root).removeClass('collapsed').addClass('expanded').html('<img src="img/open.png">');
				$("li:has(> ul.hide) > span", $root).removeClass('expanded').addClass('collapsed').html('<img src="img/close.png">');
				return false;
			});
