...
(function($){
  ...
  $.fn.extend({
    mycolorpicker: function(o){
      return this.each(function(){
				o = o || {};
				var opt = {};
				$.each($.mycolorpicker, function(k,v){
			...
			div_colorpicker_label.addClass('mycolorpicker-label');
			div_colorpicker_label.text(lbl.text());
			
			var div_colorpicker=$(document.createElement('div'));
			div_colorpicker.addClass('mycolorpicker');
			
			var div_colorpicker_fill=$(document.createElement('div'));
			div_colorpicker_fill.addClass('mycolorpicker-fill');
		...
		div_colorpicker.click(function(){
		txt.click();
		});
